...
This model is classified as a "class IIa model" (Patial Technical Bias Model) in the above manuscript. By their description, these are models that _account for technical bias as seen in a partial technical process._
